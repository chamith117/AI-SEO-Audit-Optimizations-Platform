...
class WebsiteAuditReport(BaseModel):
    ...
    ai_visibility_score: int = Field(default=0, ge=0, le=100, description="AI/LLM visibility score (structured data, schemas, etc)")
    site_speed_score: int = Field(default=0, ge=0, le=100, description="Site speed performance score")
    site_health_score: int = Field(default=0, ge=0, le=100, description="Overall site health score")
